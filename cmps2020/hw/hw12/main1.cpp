...
int main()
  ...
  do
    ...
    cout << "  t Search the tree (iterative)for a value                 \n";
    cout << "  s Search the tree for a value                 \n";
    ...
    switch(selection)
      ...
      case 's':
        ...
        if((tnp = tree.search(elem))  )
          {
          cout << elem << " was found in the tree at address "<< tnp << endl;
          }
        else
          {
      ...
      case 't':
        Prompt("Enter element to search for: ",elem);
        if((tnp = tree.iterativeSearch(elem))  )
          {
          cout << elem << " was found in the tree at address "<< tnp << endl;
          }
        else
